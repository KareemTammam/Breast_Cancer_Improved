...
DARK_OVERRIDES = {
    ...
    "text": "#E8EEF4",
    "text_muted": "#94A3B8",
    "primary_light": "rgba(37, 99, 235, 0.18)",
...
def inject_css(dark: bool = False):
    ...
    st.markdown(
        ...
        .dev-signature {{
            ...
            background: linear-gradient(90deg, #60A5FA 0%, #A78BFA 40%, #F472B6 75%, #FBBF24 100%);
        ...
        .dev-signature:hover {{
            ...
            filter: drop-shadow(0 4px 14px rgba(167, 139, 250, 0.55));
